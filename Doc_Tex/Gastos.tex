...
\subsection{Indicadores del Mes}
El módulo encabeza con cuatro indicadores que responden a las preguntas inmediatas del usuario: \textbf{cuánto lleva gastado} en el mes en curso, con su variación respecto del mes anterior y su avance sobre el presupuesto; la \textbf{proyección de cierre}, que extrapola el ritmo diario al total del mes y advierte si se superará el límite; el \textbf{gasto comprometido}, esto es, la porción del mes que corresponde a cuotas y suscripciones y sobre la cual no cabe decisión; y el \textbf{promedio mensual}, calculado únicamente sobre meses cerrados para que la comparación sea legítima.

Estos valores se presentan como cifras y no como gráficos: para un dato único, un gráfico de una sola barra no aporta nada que el número no exprese con mayor claridad.
