...
\subsection{Ritmo y Plazo}
El saldo acumulado, por sí solo, no permite juzgar si el usuario avanza adecuadamente. Por ello el módulo encabeza con cuatro indicadores: el \textbf{total ahorrado}, el \textbf{ritmo mensual} (promedio neto de los meses con movimiento, no de los meses corridos, para no penalizar a quien ahorra de forma intermitente), la \textbf{brecha} hasta la meta más próxima con su barra de avance, y una \textbf{estimación de plazo}: cuántos meses restan para alcanzar dicha meta si se mantiene el ritmo actual. Cuando el ritmo es nulo o negativo, el sistema lo señala expresamente en lugar de ofrecer una proyección carente de sentido.
